...
public class Queries {
	...
	public static final String ADD_USER_TO_SECRET_SANTA = 
			"INSERT INTO atlas.ss_person(first_name,last_name,email,spouse_id,availability,assignedPersonId,create_date,modify_date) "+
